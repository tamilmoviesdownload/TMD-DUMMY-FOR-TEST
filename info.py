...
PICS = (environ.get('PICS', 'https://telegra.ph/file/58fef5cb458d5b29b0186.jpg')).split() #random anime girl img each time from aniwallpaper (Experimental)
...
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "https://telegra.ph/file/58fef5cb458d5b29b0186.jpg")
...
auth_channels     = environ.get("AUTH_CHANNELS", "-1002908058571")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://files.catbox.moe/4feiis.jpg')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'tmd-botz@ptaxis')    # Owner UPI ID for payments
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+O8kEnZRbqBk4YzBl') # Group link for the bot
...
MAX_B_TN = environ.get("MAX_B_TN", "7") # Maximum number of buttons in a row (default: 5)
